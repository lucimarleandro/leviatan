...
$this->Html->addCrumb('Adicionar', array('controller'=>'input_categories', 'action'=>'add'));
...
<div class="well">
	<?php echo $this->Form->create('InputCategory', array('class'=>'form-horizontal')); ?>
		<fieldset>
			<legend>Adicionar Categoria de Insumo</legend>
			...
			<div class="control-group required">
				...
				<div class="controls">
					<?php 
                    echo $this->Tinymce->input('InputCategory.description', 
                        array(
                            'label'=>false,
                            'class'=>'span9',
                            'rows'=>10
