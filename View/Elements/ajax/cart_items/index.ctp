	...
	<table id="table" class="table table-bordered table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<?php 
				echo $this->Html->link($this->Html->image('refresh'), 
				'javascript:void(0)', 
				array('escape'=>false, 'class'=>'edit-quantity', 'value'=>$item['CartItem']['id'], 'title'=>'Editar quantidade do item'));
				?>
				</td>
				<td>
					<?php 
					echo $this->Html->link(
						...
						'javascript:void(0)', 
						array('escape'=>false, 'class'=>'remove-cart-item', 'value'=>$item['CartItem']['id'], 'title'=>'Remover o item')
					);
