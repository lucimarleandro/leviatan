				...
				<tr>
					...
					<td>
						...
						echo $this->Html->link(
							...
							array('controller'=>'items', 'action'=>'view', $solicitationItem['Item']['id'])
						);						
						?>
					</td>
					...
					if($solicitationItem['SolicitationItem']['status_id'] == PENDENTE) {
						echo $this->Html->link(
							$this->Html->image('add'),
							'javascript:void(0)',
							array('escape'=>false, 'title'=>'Aceitar o item', 'class'=>'accept', 'value'=>$solicitationItem['SolicitationItem']['id'])
						);
						echo $this->Html->link(
							$this->Html->image('stop'),
							'javascript:void(0)',
							array('escape'=>false, 'title'=>'Não aceitar o item', 'class'=>'deny', 'value'=>$solicitationItem['SolicitationItem']['id'])
						);
