...
$this->Html->addCrumb('Funcionários', '/employees/');
$this->Html->addCrumb('Editar', '/employees/edit/'.$this->request->data['Employee']['id']);
				...
				<div class="controls">
					...
					echo $this->Form->input('unity_id', 
						array(
							...
							'class'=>'input-xxlarge',
							'options'=>$unities,
							'value'=>$this->request->data['UnitySector']['unity_id']
						)
					);
					?>
				</div>
				...
				<div class="controls">
					...
					echo $this->Form->input('sector_id', 
						array(
							...
							'class'=>'input-xxlarge',
							'options'=>$sectors,
							'value'=>$this->request->data['UnitySector']['sector_id']
						)
					);
					?>
				</div>
